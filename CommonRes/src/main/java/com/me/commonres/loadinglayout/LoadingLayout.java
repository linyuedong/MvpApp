package com.me.commonres.loadinglayout;
...
public class LoadingLayout extends FrameLayout {
    ...
    private void build() {
        ...
        errorPage = LayoutInflater.from(mContext).inflate(R.layout.sv_error_layout, null);
        emptyPage = LayoutInflater.from(mContext).inflate(R.layout.sv_empty_layout, null);
        ...
        errorText = Utils.findViewById(errorPage, R.id.sv_error_tip);
        emptyText = Utils.findViewById(emptyPage, R.id.sv_empty_tip);
        networkText = Utils.findViewById(networkPage, R.id.no_network_text);

        errorImg = Utils.findViewById(errorPage, R.id.sv_error_icon);
        emptyImg = Utils.findViewById(emptyPage, R.id.sv_empty_icon);
        networkImg = Utils.findViewById(networkPage, R.id.no_network_img);

        errorReloadBtn = Utils.findViewById(errorPage, R.id.sv_error_retry);
