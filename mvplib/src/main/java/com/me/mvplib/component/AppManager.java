package com.me.mvplib.component;
...
public final class AppManager {
    ...
    public void startActivity(Intent intent) {
        if (getTopActivity() == null) {
            LogUtlis.w("mCurrentActivity == null when startActivity(Intent)");
    ...
    public Activity getTopActivity() {
        if (mActivityList == null) {
            LogUtlis.w("mActivityList == null when getTopActivity()");
            return null;
        }
    ...
    public void removeActivity(Activity activity) {
        if (mActivityList == null) {
            LogUtlis.w("mActivityList == null when removeActivity(Activity)");
            return;
        }
        synchronized (AppManager.class) {
    ...
    public Activity removeActivity(int location) {
        if (mActivityList == null) {
            LogUtlis.w("mActivityList == null when removeActivity(int)");
            return null;
        }
        synchronized (AppManager.class) {
    ...
    public void killActivity(Class<?> activityClass) {
        if (mActivityList == null) {
            LogUtlis.w("mActivityList == null when killActivity(Class)");
            return;
        }
        synchronized (AppManager.class) {
    ...
    public boolean activityInstanceIsLive(Activity activity) {
        if (mActivityList == null) {
            LogUtlis.w("mActivityList == null when activityInstanceIsLive(Activity)");
            return false;
        }
    ...
    public boolean activityClassIsLive(Class<?> activityClass) {
        if (mActivityList == null) {
            LogUtlis.w("mActivityList == null when activityClassIsLive(Class)");
            return false;
        }
    ...
    public Activity findActivity(Class<?> activityClass) {
        if (mActivityList == null) {
            LogUtlis.w("mActivityList == null when findActivity(Class)");
            return null;
        }
        for (Activity activity : mActivityList) {
            if (activity.getClass().equals(activityClass)) {
